                    ...
                    <Form onSubmit={handleSubmit(onSubmit)}>
                      <Form.Group>
                        ...
                        <Form.Field width={8} required>
                          ...
                          {requestError === "Usuário já cadastrado!" && <ErrorMessage>{requestError}</ErrorMessage>}
                        </Form.Field>
                      </Form.Group>
                      <Form.Field required>
                        <label>E-mail</label>
                        ...
                        {requestError === "E-mail já cadastrado!" && <ErrorMessage>{requestError}</ErrorMessage>}
                      </Form.Field>
                      <Form.Group>
                        <Form.Field width={8} required>
                          <label>Senha</label>
                        ...
                        <Form.Field width={8} required>
                          ...
                          {requestError === "Erro de requisição!" && <ErrorMessage>{requestError}</ErrorMessage>}
                        </Form.Field>
                      </Form.Group>
                      <Login> Já possui conta? Entrar! </Login>
                      <StyledButton type="submit" inverted color="red">Cadastrar</StyledButton>
                    </Form>
                  </LoginBox>
                </Grid.Column>
              </Grid.Row>
